...
import { getStoreInfoAPI } from "../../api/custStoreAPI";
...
const Store = (props) => {
  ...
  useEffect(() => {
    const getData = async () => {
      const storeData = await getStoreInfoAPI(storeLink);
    ...
    <div className={styles.container}>
      ...
      <div className={styles.products}>
        ...
        <div className={styles.product_item}>
          <img
            src="https://media.thieve.co/products%2F44Qbo6o94pLq4kSQOqz4.jpg?fm=jpg&dpr=1&q=70&w=354&h=354"
            alt="img"
